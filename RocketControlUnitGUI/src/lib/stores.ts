...
export interface Stores {
	...
	tc5: Writable<string | number | undefined>;
	tc3: Writable<string | number | undefined>;
	...
	nos3_temperature: Writable<string | number | undefined>;
	tc6_temperature: Writable<string | number | undefined>;
	rcu_tc9: Writable<string | undefined>;
	timer_state: Writable<string | undefined>;
	tc4: Writable<number | undefined>;
...
export const initStores = () => {
	return {
		...
		tc8: writable(undefined),
		nos1_mass: writable(undefined),
		nos2_mass: writable(undefined),
		ib_pressure: writable<string | number | undefined>(undefined),
		tc5: writable<string | number | undefined>(undefined),
		tc3: writable<string | number | undefined>(undefined),
		...
		nos3_temperature: writable<string | number | undefined>(undefined),
		tc6_temperature: writable<string | number | undefined>(undefined),
		rcu_tc9: writable<string | undefined>(undefined),
		timer_state: writable<string | undefined>(undefined),
		tc4: writable<number | undefined>(undefined),
